            ...
            options = {
              ...
              protocol = lib.mkOption {
                ...
                description = ''
                  ...
                  The value `auto` lets `cloudflared` choose the protocol (currently QUIC, falling back to HTTP/2). Set to `http2` to work around QUIC/UDP connectivity issues, such as restrictive firewalls, broken UDP path MTU, or QUIC interop bugs (see e.g. [zhaofengli/attic#281](https://github.com/zhaofengli/attic/issues/281)). Set to `quic` to force QUIC.
